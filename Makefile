# ====================================================================================
# Setup Project
PROJECT_NAME := provider-opentofu
...
xpkg.build.provider-opentofu: do.build.images
...
run: go.build
	...
	@# KUBE_CONFIG_PATH explained at  https://opentofu.org/docs/language/settings/backends/kubernetes/
...
.PHONY: go.cachedir go.mod.cachedir go.lint.analysiskey-interval go.lint.analysiskey
